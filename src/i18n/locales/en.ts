    ...
    general: {
      ...
      globalFilter: {
        ...
        syntaxHelp: {
          ...
          intro:
            'Supports paths, tags, AND / OR / NOT logic, and [property] / [property:value] filters. Properties can come from frontmatter or file fields such as path, name, basename, and extension.',
      ...
      recentFiles: {
        ...
        columns: {
          ...
          syntaxHelp: {
            ...
            intro:
              'Supports paths, tags, AND / OR / NOT logic, plus [property] and [property:value] filters. Properties can come from frontmatter or file fields such as path, name, basename, and extension.',
