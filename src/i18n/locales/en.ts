export default {
  settings: {
    ...
    general: {
      ...
      globalFilter: {
        name: 'Global Filter',
        desc: 'Filter applied to Recent Files and Random Note modules. Supports logical operators (AND, OR, NOT), tags (#tag), strings ("folder"), and property filters in the [property:value] form.',
        syntaxHelp: {
          label: 'Query syntax examples',
          ariaLabel: 'Show global filter query syntax help',
          intro:
            'Supports paths, tags, AND / OR / NOT logic, and [property] / [property:value] filters. Properties can come from frontmatter or file fields such as path, name, basename, extension, parent.name, and parent.path. The right side can also reference another file field with `@field`.',
          exampleExclude: 'Example: (-"SCRIPTS") AND (-"TODO")',
          exampleTag: 'Example: #published',
          exampleProperty: 'Example: [status:active]',
          exampleFileProperty: 'Example: [extension:base]',
          exampleFieldReference: 'Example: [basename:@parent.name]',
    ...
    settings: {
      ...
      recentFiles: {
        ...
        columns: {
          ...
          desc: "Configure the columns displayed in the Recent Files module. The 'Source' field supports Dataview-like queries plus property filters such as [property] and [property:value].",
          syntaxHelp: {
            label: 'Query syntax examples',
            ariaLabel: 'Show recent files query syntax help',
            intro:
              'Supports paths, tags, AND / OR / NOT logic, plus [property] and [property:value] filters. Properties can come from frontmatter or file fields such as path, name, basename, extension, parent.name, and parent.path. The right side can also reference another file field with `@field`.',
          ...
          sourcePlaceholder: 'e.g. "Folder" AND #tag AND [status:active] AND [extension:base]',
