    ...
    general: {
      ...
      globalFilter: {
        ...
        syntaxHelp: {
          ...
          intro:
            '支持小径们，标签们，和 / 或 / 非逻辑，以及 [财产] / [财产:值] 形式的过滤；财产可以来自前物质，也可以来自锉刀字段，像 path、name、basename、extension、parent.name、parent.path；右边也可以用 `@字段` 去引用别的锉刀字段。',
          exampleExclude: '例子：(-"脚本") AND (-"去做")',
          exampleTag: '例子：#被发表的',
          exampleProperty: '例子：[状态:活跃的]',
          exampleFileProperty: '例子：[extension:base]',
          exampleFieldReference: '例子：[basename:@parent.name]',
      ...
      recentFiles: {
        ...
        columns: {
          ...
          syntaxHelp: {
            ...
            intro:
              '支持小径、标签、AND / OR / NOT 逻辑操作员，也支持 [财产] / [财产:值] 形式的过滤；财产可以来自前物质，也可以来自锉刀字段，像 path、name、basename、extension、parent.name、parent.path；右边也可以用 `@字段` 去引用别的锉刀字段。',
